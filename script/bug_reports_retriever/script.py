...
import math
def crash_report(product = "Firefox",version = "64.0rc1",nums_buck = 1,url_2_bucket="bye"):
     #初始化
    ...
    if url_2_bucket=="bye":
        ...
        for i in range(nums_buck):
            ...
            url_2=url+"/signature/reports/?product="+product+"&version="+version+"&signature="+url_2_bucket+"&_columns=date&_columns=product&_columns=version&_columns=build_id&_columns=platform&_columns=reason&_columns=address&_columns=install_time&_sort=-date&page="
...
#例子
crash_report("Firefox","64.0.2",1,"ntdll.dll | amf-wic-jpeg-decoder64.dll | ntdll.dll | amf-wic-jpeg-decoder64.dll | VirtualQuery")
